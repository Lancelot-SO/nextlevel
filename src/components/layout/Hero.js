        ...
        <section className="hero">
            <div className="py-12">
                <h1 className="text-4xl font-semibold">
                    ...
                    <spn className="text-primary">Pizza</spn>
                </h1>
                <p className="my-6 text-gray-500 text-sm">
                    Pizza is the missing piece that makes every
                    day complete, a simple yet delicious joy
                    in life
                </p>
                <div className="flex gap-4 text-sm">
                    <button className="bg-primary flex gap-2 text-white
                px-4 py-2 rounded-full uppercase items-center">
                        Order Now
                        <Right />
                    </button>
                    <button className="flex font-semibold text-gray-600 py-2 gap-2">
                        Learn more
                        <Right />
                    </button>
                </div>
